        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Circles_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalSchema: "public",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CircleMemberships", x => new { x.CircleId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CirclePosts", x => new { x.CircleId, x.PostId });
                    table.ForeignKey(
                        name: "FK_CirclePosts_Circles_CircleId",
                        column: x => x.CircleId,
                        principalSchema: "public",
                        principalTable: "Circles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CirclePosts_Posts_PostId",
                        column: x => x.PostId,
                        principalSchema: "public",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CirclePosts_CircleId",
                schema: "public",
                table: "CirclePosts",
                column: "CircleId");

            migrationBuilder.CreateIndex(
                name: "IX_CirclePosts_PostId",
                schema: "public",
                table: "CirclePosts",
                column: "PostId");
